...
function parseTestCaseFile(dir: string, category: string, filename: string): CompletionTestCase {
  ...
  return {
    ...
    exact: (meta.exact as boolean) ?? false,
  };
}

export function loadCompletionTests(category: string): CompletionTestCase[] {
